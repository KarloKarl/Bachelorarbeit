...
\input{../Kapitel/Einleitung/01_Hintergrund_Motivation.tex}


\input{../Kapitel/Einleitung/02_Problemstellung.tex}


\input{../Kapitel/Einleitung/03_Ziele.tex}


\input{../Kapitel/Einleitung/04_Aufbau.tex}
...
\input{../Kapitel/Theoretische_Grundlagen/01_Grundlagen_von_Bilanzräumen/01_Energiebilanzierung.tex}
\input{../Kapitel/Theoretische_Grundlagen/01_Grundlagen_von_Bilanzräumen/02_Definition_von_Bilanzräumen.tex}
\input{../Kapitel/Theoretische_Grundlagen/01_Grundlagen_von_Bilanzräumen/03_Energiequellen_und_-senken.tex}
\input{../Kapitel/Theoretische_Grundlagen/01_Grundlagen_von_Bilanzräumen/04_Bilanzraumstrukturen.tex}

\section{Bilanzräume im Energiemanagement nach ISO 50001}

\input{../Kapitel/Theoretische_Grundlagen/02_Bilanzräume_im_Energiemanagement_nach_ISO_50001/01_Abbildung_des_Organisationskontext.tex}

\input{../Kapitel/Theoretische_Grundlagen/02_Bilanzräume_im_Energiemanagement_nach_ISO_50001/02_Energieleistungskennzahlen.tex}

\input{../Kapitel/Theoretische_Grundlagen/02_Bilanzräume_im_Energiemanagement_nach_ISO_50001/03_Energieeinsätze.tex}

\input{../Kapitel/Theoretische_Grundlagen/02_Bilanzräume_im_Energiemanagement_nach_ISO_50001/04_Reporting.tex}

\section{Ansätze zur Datenbankseitigen Abbildung}

\input{../Kapitel/Theoretische_Grundlagen/03_Ansätze_zur_Datenbankseitigen_Abbildung/01_Datenstrukturen_zur_Abbildung_von_Bilanzräumen.tex}

\input{../Kapitel/Theoretische_Grundlagen/03_Ansätze_zur_Datenbankseitigen_Abbildung/02_Abbildung_der_Datenstrukturen_in_relationalen_Datenbanken.tex}
