...
\begin{longtable}{| m{0.06\textwidth} | m{0.16\textwidth} | m{0.38\textwidth} | m{0.4\textwidth} |}
    ...
    & Das Bilanzraumkonzept \textbf{muss} für jeden definierten EnPI die Möglichkeit bieten, relevante Variablen zu definieren. 
    & Die Analyse von relevanten Variablen und deren Auswirkung auf EnPIs ist einer der Grundlegenden Anforderungen 
    zur erfüllung von Anforderungen der DIN EN ISO 50001:2018-12.
